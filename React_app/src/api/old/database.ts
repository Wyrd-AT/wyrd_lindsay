...
import { getSyncActiveCount, incrementSyncActiveCount, decrementSyncActiveCount } from '../../stores/old/syncCounterStore';

PouchDB.plugin(PouchDBFind);

// Database connections
export const localDB = new PouchDB('lindsay');
//export const remoteDB = new PouchDB('https://admin:wyrd@db.vpn.ind.br/lindsay-data', { skip_setup: true });
export const remoteDB = new PouchDB('http://admin:wyrd@54.211.31.145:5984/lindsay-data', { skip_setup: true });
