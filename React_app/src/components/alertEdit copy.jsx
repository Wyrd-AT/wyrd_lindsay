    ...
    >
      ...
      >
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {/* <button className="bg-[#08cb7c] text-white text-xs font-medium px-3 py-1 rounded-full">
            Ligar Alarme
          </button>
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="bg-[#08cb7c] hover:bg-green-600 text-white text-sm px-5 py-2 rounded-full">
            SALVAR
          </button>
        </div>
      </div>
