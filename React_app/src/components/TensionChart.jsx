 ...
 */
const TensionChart = forwardRef(function TensionChart(
  {
    irrigadorId,
    equipments = [],
    period = 'last24h',
  ...
  // wrapper para captura pelo html2canvas
  const containerRef = useRef(null);

  // expõe o elemento e um nome de arquivo amigável
  useImperativeHandle(ref, () => ({
    getExportElement: () => containerRef.current,
    getFileName: () =>
      `tensoes_${irrigadorId}_${period}.pdf`.replace(/\s+/g, '_'),
  }), [irrigadorId, period]);
  ...
  return (
    <div ref={containerRef} className="bg-[#222222] px-8">
      <h3 className="text-start py-4 px-2 bg-[#222222] text-white">
        Histórico de tensões de {currentLabel}
      </h3>
